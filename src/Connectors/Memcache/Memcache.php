...
namespace Smf\ConnectionPool\Connectors\Memcache;

use Smf\ConnectionPool\Connectors\Memcache\Exception\ConnectException;
use Smf\ConnectionPool\Connectors\Memcache\Exception\MemcacheException;
 ...
 * 协程Memcache客户端
 * Class Memcache
 * @package Smf\ConnectionPool\Connectors\Memcache
 */
class Memcache
{
    ...
    function connect($host, $port, int $timeout = null)
    {
